            ...
            <div class="iccwp" style="padding:10px;" >
                ...
                <div class="Polling station">
                   ...
                   <h3>select role</h3>
                    ...
                    <button type="submit" id="register"style="width:100px;padding:10px;height:50px;background-color:green;color:aliceblue;font-size:20px;border-radius:20px;">Register</a></button>                                
